...
VERBOSE_OPT="--verbose"
DEBUG_OPT=
ALL_TABLES="current_identifications numbered_identifications"

# CSV dialect definitions for the tables
current_identifications_CSV_DIALECT="--fields-terminated-by=, --fields-enclosed-by='"
numbered_identifications_CSV_DIALECT="--fields-terminated-by=, --fields-enclosed-by='"
